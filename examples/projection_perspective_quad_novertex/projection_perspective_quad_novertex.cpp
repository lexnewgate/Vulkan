...
public:
	...
	void preparePipelines()
	{
		...
		shaderStages[0].module = loadSPIRVShader(getAssetPath() + "shaders/projection_perspective_quad_novertex/triangle.vert.spv");
		...
		// Load binary SPIR-V shader
		shaderStages[1].module = loadSPIRVShader(getAssetPath() + "shaders/projection_perspective_quad_novertex/triangle.frag.spv");
		// Main entry point for the shader
