...
class VulkanExample : public VulkanExampleBase {
 public:
  ...
  void preparePipelines() {
    ...
    shaderStages[0] = loadShader(getAssetPath() + "shaders/projection_perspective_mesh_quad/mesh.vert.spv",
                                 VK_SHADER_STAGE_VERTEX_BIT);
    shaderStages[1] = loadShader(getAssetPath() + "shaders/projection_perspective_mesh_quad/mesh.frag.spv",
