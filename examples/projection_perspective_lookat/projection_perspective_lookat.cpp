...
class VulkanExample : public VulkanExampleBase {
  ...
  */
  ...
  void preparePipelines() {
    ...
    shaderStages[0] =
        loadShader(getAssetPath() +
                       "shaders/projection_perspective_lookat/texture.vert.spv",
                   VK_SHADER_STAGE_VERTEX_BIT);
    shaderStages[1] =
        loadShader(getAssetPath() +
                       "shaders/projection_perspective_lookat/texture.frag.spv",
  ...
  void updateUniformBuffers() {
    ...
    // 0.0f, zoom)); glm::mat4 viewMatrix = glm::translate(glm::mat4(1.0f),
    // glm::vec3(0.0f, 0.0f, 0.0f));

    uboVS.view = glm::lookAt(glm::vec3(0.0f), glm::vec3(0.0f, 0.5f, -1.0f),
