 ...
 *
 * 3D1 Example - Basic Quad rendering without vertex information
 *
 */
 ...
 public:
  ...
  void preparePipelines() {
    ...
    shaderStages[0].module = loadSPIRVShader(
        getAssetPath() +
        "shaders/projection_perspective_quad_novertex/triangle.vert.spv");
    ...
    shaderStages[1].module = loadSPIRVShader(
        getAssetPath() +
        "shaders/projection_perspective_quad_novertex/triangle.frag.spv");
    // Main entry point for the shader
