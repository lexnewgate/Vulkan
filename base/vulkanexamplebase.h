...
class VulkanExampleBase {
 private:
  ...
  /** brief Indicates that the view (position, rotation) has changed and buffers
   * containing camera matrices need to be updated */
 ...
 protected:
  ...
  /**
   * Set of physical device features to be enabled for this example (must be set
...
//
  ...
  // Can be overriden in derived class to recreate or rebuild resources attached
  // to the frame buffer / swapchain
  virtual void windowResized();
  // Pure virtual function to be overriden by the dervice class
  // Called in case of an event where e.g. the framebuffer has to be rebuild and
  // thus all command buffers that may reference this
