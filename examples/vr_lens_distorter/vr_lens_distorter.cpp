...
class VulkanExample : public VulkanExampleBase {
 public:
  ...
  void loadAssets() {
    loadModel(getAssetPath() + "models/vrgrid.dae");
    if (true) {
  ...
  void preparePipelines() {
    ...
    shaderStages[0] = loadShader(
        getAssetPath() + "shaders/vr_lens_distorter/texture.vert.spv",
        VK_SHADER_STAGE_VERTEX_BIT);
    shaderStages[1] = loadShader(
        getAssetPath() + "shaders/vr_lens_distorter/texture.frag.spv",
