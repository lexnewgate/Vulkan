...
public:
	...
	void preparePipelines()
	{
		...
		{
			// Shaders
			shaderStages[0] = loadShader(getAssetPath() + "shaders/primitive_point_particle/particle.vert.spv", VK_SHADER_STAGE_VERTEX_BIT);
			shaderStages[1] = loadShader(getAssetPath() + "shaders/primitive_point_particle/particle.frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT);
