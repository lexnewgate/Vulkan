...
*
* 3D1 Example - Diffuse lighting and specular lighting
*
*/
...
public:
	...
	*/
	...
	void preparePipelines()
	{
		...
		shaderStages[0] = loadShader(getAssetPath() + "shaders/projection_perspective_lighting/texture.vert.spv", VK_SHADER_STAGE_VERTEX_BIT);
		shaderStages[1] = loadShader(getAssetPath() + "shaders/projection_perspective_lighting/texture.frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT);
