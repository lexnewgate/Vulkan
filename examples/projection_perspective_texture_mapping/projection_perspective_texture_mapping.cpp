  ...
  */
  ...
  void generateQuad() {
    ...
    */
    ...
    if (strncmp(clipMode, "full", sizeof(clipMode)) == 0) {
      ...
      vertices = {
          ...
          {{rightAtAnyZ, bottomAtAnyZ, zEye},
           {1.0f * textureScale, 1.0f * textureScale},
           {1.0f, 1.0f, 1.0f}},
    ...
    } else if (strncmp(clipMode, "zoom4", sizeof(clipMode)) == 0) {
      float textureScale = 4.0;
      vertices = {
          {{leftAtAnyZ, bottomAtAnyZ, zEye},
           {0.0f, 1.0f * textureScale},
           {1.0f, 0.0f, 1.0f}},
    ...
    } else if (strncmp(clipMode, "left_top", sizeof(clipMode)) == 0) {
